...
//static ARM_DRIVER_USART *usart1 = &Driver_USART1;
...
osThreadId uart_thread_init(void)
{
  thread_id = osThreadCreate(osThread(myUART_Thread), NULL);
  return thread_id;
}
